...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/appearance/edit', fn () => Inertia::render('Settings/Appearance'))->name('appearance.edit');
    Route::put('/appearance', fn () => response()->noContent())->name('appearance.update');
...
Route::middleware(['guest:' . config('fortify.guard')])->group(function () {
    // Forgot password (Fortify handles controller internally – just expose the route)
